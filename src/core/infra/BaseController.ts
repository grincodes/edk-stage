...
import { DecodedExpressRequest } from "../../modules/users/infra/http/models/decodeRequest"

export abstract class BaseController {
  // or even private
  protected req: express.Request
  protected res: express.Response
  protected authReq: JWTClaims

  protected abstract executeImpl(): Promise<void | any>

  public execute(req: express.Request, res: express.Response, authReq?: JWTClaims): void {
    this.req = req
    this.res = res
