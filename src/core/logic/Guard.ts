...
export interface IGuardAtLeast {
  numChars: number
  text: string
  argumentName: string
}
...
export type GuardAtLeastCollection = IGuardAtLeast[]
...
export class Guard {
  ...
  public static againstAtLeastBulk(args: GuardAtLeastCollection): IGuardResult {
